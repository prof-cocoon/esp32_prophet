...
struct midiControllerMapping edirolMapping[] =
{
    ...
    { 0x1, 0x50, "A2", NULL, Synth_SetCurCh, 1}, //////// Preset Change 0-15
    ...
    { 0x0, 0x12, "NOISE OUTPUT LEVEL", NULL, Synth_SetParam, SYNTH_PARAM_VOICE_NOISE_LEVEL},
///////////////////////////////////////////////////////////////////////////////////////////////////////////   New Parameters
    { 0x0, 0x41, "OSC 2 MOD FILTER", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_FILTER},
    { 0x0, 0x42, "OSC 2 KBD TRACKING", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_KBD_TRACKING},
    { 0x0, 0x43, "OSC 2 LOW FREQ", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_LOW_FREQ},
    { 0x0, 0x44, "OSC 2 FINE TUNING", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_FINE},
    { 0x0, 0x45, "FILTER ENV -> OSC-A", NULL, Synth_SetParam, SYNTH_PARAM_PITCH_ENV},
    { 0x0, 0x46, "LFO MOD SPEED", NULL, Synth_SetParam, SYNTH_PARAM_LFO_MOD_SPEED},
    { 0x0, 0x47, "OSC 1 LEVEL", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_LEVEL},
    { 0x0, 0x48, "OSC 2 LEVEL", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_LEVEL},
    { 0x0, 0x49, "OSC 1 TRANSPOSE", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_TRANSPOSE},
    { 0x0, 0x4a, "OSC 2 TRANSPOSE", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_TRANSPOSE},
    { 0x0, 0x4b, "FILTER KBD TRACKING", NULL, Synth_SetParam, SYNTH_PARAM_FILTER_KBD_TRACKING},
    { 0x0, 0x4c, "LFO WAVEFORM", NULL, Synth_SetParam, SYNTH_PARAM_LFO_WAVEFORM},
    { 0x0, 0x4d, "LFO MOD CUTOFF", NULL, Synth_SetParam, SYNTH_PARAM_LFO_MOD_CUTOFF},
    { 0x0, 0x4e, "FILTER ENV AMT", NULL, Synth_SetParam, SYNTH_PARAM_FILTER_ENV_AMT},
    { 0x0, 0x4f, "VOICE FILTER CUTOFF", NULL, Synth_SetParam, SYNTH_PARAM_VOICE_FILTER_CUTOFF},
    { 0x1, 0x41, "PORTAMENTO TIME", NULL, Synth_SetParam, SYNTH_PARAM_VOICE_PORT_TIME},
    { 0x1, 0x42, "OSC 1 FM OSC2", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_FM},
    { 0x1, 0x43, "OSC 1 PULSE WIDTH", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_PW},
    { 0x1, 0x44, "OSC 2 PULSE WIDTH", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_PW},
    { 0x1, 0x45, "OSC 1 PULSE WIDTH MOD", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_PWM},
    { 0x1, 0x46, "OSC 2 PULSE WIDTH MOD", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_PWM},
    { 0x1, 0x47, "OSC 1 PULSE WIDTH ENV MOD", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_PWM_ENV},
    { 0x1, 0x48, "LFO SOURCE", NULL, Synth_SetParam, SYNTH_PARAM_LFO_SOURCE},

    { 0x1, 0x4a, "GLOBAL GAIN", NULL, Synth_SetParam, SYNTH_PARAM_GLOBAL_GAIN},
    { 0x1, 0x4b, "OSC 1 PITCH MOD", NULL, Synth_SetParam, SYNTH_PARAM_OSC1_PITCH_MOD},
    { 0x1, 0x4c, "OSC 2 PITCH MOD", NULL, Synth_SetParam, SYNTH_PARAM_OSC2_PITCH_MOD},
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    /* Central slider */
